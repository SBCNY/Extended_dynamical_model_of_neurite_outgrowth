...
% statevar_figure_names{index} = 'Vesicles B1 - CBC';
statevar_figure_names{index} = {'Vesicles';'B1 - CBC'}; %{'Vesicles';'B1 - CBC'};
...
statevar_explaination{index} = 'Coat B budded membrane from TNG - MTC ';
% statevar_figure_names{index} = 'Vesicles B1 - MTC'; 
statevar_figure_names{index} ={'Vesicles';'B1 - MTC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = '[\mum{^2}] ';
...
% statevar_figure_names{index} = 'Vesicles B1 - GCC'; 
statevar_figure_names{index} ={'Vesicles';'B1 - GCC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = '[\mum{^2}] ';
...
% statevar_figure_names{index} = 'Vesicles A1 - CBC'; 
statevar_figure_names{index} ={'Vesicles';'A1 - CBC'};
...
% statevar_figure_names{index} = 'Vesicles A1 - MTC'; 
statevar_figure_names{index} ={'Vesicles';'A1 - MTC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = '[\mum{^2}] ';
...
% statevar_figure_names{index} = 'Vesicles A1 - GCC'; 
statevar_figure_names{index} ={'Vesicles';'A1 - GCC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = '[\mum{^2}] ';
...
% statevar_figure_names{index} = 'Vesicles B2 - CBC'; 
statevar_figure_names{index} ={'Vesicles';'B2 - CBC'};
...
% statevar_figure_names{index} = 'Vesicles B2 - MTC'; 
statevar_figure_names{index} ={'Vesicles';'B2 - MTC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = '[\mum{^2}] ';
...
% statevar_figure_names{index} = 'Vesicles B2 - GCC'; 
statevar_figure_names{index} ={'Vesicles';'B2 - GCC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = '[\mum{^2}] ';
...
% statevar_figure_names{index} = 'Vesicles A2 - CBC'; 
statevar_figure_names{index} ={'Vesicles';'A2 - CBC'};
...
% statevar_figure_names{index} = 'Vesicles A2 - MTC'; 
statevar_figure_names{index} ={'Vesicles';'A2 - MTC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = '[\mum{^2}] ';
...
% statevar_figure_names{index} = 'Vesicles A2 - GCC'; 
statevar_figure_names{index} ={'Vesicles';'A2 - GCC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = '[\mum{^2}] ';
...
% statevar_figure_names{index} = 'SNARE Y - B1 - CBC'; 
statevar_figure_names{index} ={'SNARE Y';'B1 - CBC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE Y - B1 - MTC'; 
statevar_figure_names{index} ={'SNARE Y';'B1 - MTC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE Y - B1 - GCC'; 
statevar_figure_names{index} ={'SNARE Y';'B1 - GCC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE Y - A1 - CBC';  
statevar_figure_names{index} ={'SNARE Y';'A1 - CBC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat A budded total Y SNAREs from TNG - MTC'; 
% statevar_figure_names{index} = 'SNARE Y - A1 - MTC';  
statevar_figure_names{index} ={'SNARE Y';'A1 - MTC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE Y - A1 - GCC'; 
statevar_figure_names{index} ={'SNARE Y';'A1 - GCC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE Y - B2 - CBC'; 
statevar_figure_names{index} ={'SNARE Y';'B2 - CBC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE Y - B2 - MTC'; 
statevar_figure_names{index} ={'SNARE Y';'B2 - MTC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE Y - B2 - GCC'; 
statevar_figure_names{index} ={'SNARE Y';'B2 - GCC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE Y - A2 - CBC'; 
statevar_figure_names{index} ={'SNARE Y';'A2 - CBC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE Y - A2 - MTC'; 
statevar_figure_names{index} ={'SNARE Y';'A2 - MTC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE Y - A2 - GCC'; 
statevar_figure_names{index} ={'SNARE Y';'A2 - GCC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE V - B1 - CBC'; 
statevar_figure_names{index} ={'SNARE V';'B1 - CBC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat B budded total V SNAREs from TNG - MTC'; 
% statevar_figure_names{index} = 'SNARE V - B1 - MTC'; 
statevar_figure_names{index} ={'SNARE V';'B1 - MTC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE V - B1 - GCC'; 
statevar_figure_names{index} ={'SNARE V';'B1 - GCC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE V - A1 - CBC'; 
statevar_figure_names{index} ={'SNARE V';' A1 - CBC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat A budded total V SNAREs from TNG - MTC'; 
% statevar_figure_names{index} = 'SNARE V - A1 - MTC';  
statevar_figure_names{index} ={'SNARE V';'A1 - MTC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE V - A1 - GCC';  
statevar_figure_names{index} ={'SNARE V';'A1 - GCC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE V - B2 - CBC';  
statevar_figure_names{index} ={'SNARE V';'B2 - CBC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat B budded total V SNAREs from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'SNARE V - B2 - MTC';  
statevar_figure_names{index} ={'SNARE V';'B2 - MTC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE V - B2 - GCC';  
statevar_figure_names{index} ={'SNARE V';'B2 - GCC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE V - A2 - CBC';  
statevar_figure_names{index} ={'SNARE V';'A2 - CBC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat A budded total V SNAREs from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'SNARE V - A2 - MTC';  
statevar_figure_names{index} ={'SNARE V';'A2 - MTC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE V - A2 - GCC';  
statevar_figure_names{index} ={'SNARE V';'A2 - GCC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE X - B1 - CBC';  
statevar_figure_names{index} ={'SNARE X';'B1 - CBC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat B budded total X SNAREs from TNG - MTC'; 
% statevar_figure_names{index} = 'SNARE X - B1 - MTC';  
statevar_figure_names{index} ={'SNARE X';'B1 - MTC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE X - B1 - GCC';  
statevar_figure_names{index} ={'SNARE X';'B1 - GCC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE X - A1 - CBC';  
statevar_figure_names{index} ={'SNARE X';'A1 - CBC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} =  'Coat A budded total X SNAREs from TNG - MTC'; 
% statevar_figure_names{index} = 'SNARE X - A1 - MTC'; 
statevar_figure_names{index} ={'SNARE X';'A1 - MTC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE X - A1 - GCC'; 
statevar_figure_names{index} ={'SNARE X';'A1 - GCC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE X - B2 - CBC'; 
statevar_figure_names{index} ={'SNARE X';'B2 - CBC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} =  'Coat B budded total X SNAREs from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'SNARE X - B2 - MTC'; 
statevar_figure_names{index} ={'SNARE X';'B2 - MTC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE X - B2 - GCC'; 
statevar_figure_names{index} ={'SNARE X';'B2 - GCC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE X - A2 - CBC'; 
statevar_figure_names{index} ={'SNARE X';'A2 - CBC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat A budded total X SNAREs from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'SNARE X - A2 - MTC'; 
statevar_figure_names{index} ={'SNARE X';'A2 - MTC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE X - A2 - GCC';  
statevar_figure_names{index} ={'SNARE X';'A2 - GCC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE U - B1 - CBC';
statevar_figure_names{index} ={'SNARE U';'B1 - CBC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat B budded total U SNAREs from TNG - MTC'; 
% statevar_figure_names{index} = 'SNARE U - B1 - MTC'; 
statevar_figure_names{index} ={'SNARE U';'B1 - MTC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE U - B1 - GCC'; 
statevar_figure_names{index} ={'SNARE U';'B1 - GCC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE U - A1 - CBC'; 
statevar_figure_names{index} ={'SNARE U';'A1 - CBC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat A budded total U SNAREs from TNG - MTC'; 
% statevar_figure_names{index} = 'SNARE U - A1 - MTC'; 
statevar_figure_names{index} ={'SNARE U';'A1 - MTC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE U - A1 - GCC'; 
statevar_figure_names{index} ={'SNARE U';'A1 - GCC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE U - B2 - CBC'; 
statevar_figure_names{index} ={'SNARE U';'B2 - CBC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat B budded total U SNAREs from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'SNARE U - B2 - MTC'; 
statevar_figure_names{index} ={'SNARE U';'B2 - MTC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE U - B2 - GCC'; 
statevar_figure_names{index} ={'SNARE U';'B2 - GCC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE U - A2 - CBC'; 
statevar_figure_names{index} ={'SNARE U';'A2 - CBC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat A budded total U SNAREs from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'SNARE U - A2 - MTC'; 
statevar_figure_names{index} ={'SNARE U';'A2 - MTC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'SNARE U - A2 - GCC'; 
statevar_figure_names{index} ={'SNARE U';'A2 - GCC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Kinesin R - B1 - CBC'; 
statevar_figure_names{index} ={'Kinesin R';'B1 - CBC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat B budded total kinesins receptors from TNG - MTC'; 
% statevar_figure_names{index} = 'Kinesin R - B1 - MTC'; 
statevar_figure_names{index} ={'Kinesin R';'B1 - MTC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Kinesin R - B1 - GCC'; 
statevar_figure_names{index} ={'Kinesin R';'B1 - GCC'};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Kinesin R - A1 - CBC'; 
statevar_figure_names{index} ={'Kinesin R';'A1 - CBC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat A budded total kinesins receptors from TNG - MTC'; 
% statevar_figure_names{index} = 'Kinesin R - A1 - MTC'; 
statevar_figure_names{index} ={'Kinesin R';'A1 - MTC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Kinesin R - A1 - GCC'; 
statevar_figure_names{index} ={'Kinesin R';'A1 - GCC'};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Kinesin R - B2 - CBC'; 
statevar_figure_names{index} ={'Kinesin R';'B2 - CBC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat B budded total kinesins receptors from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'Kinesin R - B2 - MTC'; 
statevar_figure_names{index} ={'Kinesin R';'B2 - MTC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Kinesin R - B2 - GCC'; 
statevar_figure_names{index} ={'Kinesin R';'B2 - GCC'};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Kinesin R - A2 - CBC'; 
statevar_figure_names{index} ={'Kinesin R';'A2 - CBC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} = 'Coat A budded total kinesins receptors from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'Kinesin R - A2 - MTC'; 
statevar_figure_names{index} ={'Kinesin R';'A2 - MTC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Kinesin R - A2 - GCC'; 
statevar_figure_names{index} ={'Kinesin R';'A2 - GCC'};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Dynein R - B1 - CBC'; 
statevar_figure_names{index} ={'Dynein R';' B1 - CBC '};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} =  'Coat B budded total dynein receptors from TNG - MTC'; 
% statevar_figure_names{index} = 'Dynein R - B1 - MTC';  
statevar_figure_names{index} ={'Dynein R';' B1 - MTC '};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Dynein R - B1 - GCC';  
statevar_figure_names{index} ={'Dynein R';' B1 - GCC '};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Dynein R - A1 - CBC';  
statevar_figure_names{index} ={'Dynein R';' A1 - CBC '};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} =  'Coat A budded total dynein receptors from TNG - MTC'; 
% statevar_figure_names{index} = 'Dynein R - A1 - MTC';  
statevar_figure_names{index} ={'Dynein R';' A1 - MTC '};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Dynein R - A1 - GCC';  
statevar_figure_names{index} ={'Dynein R';' A1 - GCC '};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Dynein R - B2 - CBC';  
statevar_figure_names{index} ={'Dynein R';' B2 - CBC '};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} =  'Coat B budded total dynein receptors from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'Dynein R - B2 - MTC';  
statevar_figure_names{index} ={'Dynein R';' B2 - MTC '};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Dynein R - B2 - GCC';  
statevar_figure_names{index} ={'Dynein R';' B2 - GCC '};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Dynein R - A2 - CBC';  
statevar_figure_names{index} ={'Dynein R';' A2 - CBC '};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
statevar_explaination{index} =  'Coat A budded total dynein receptors from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'Dynein R - A2 - MTC';  
statevar_figure_names{index} ={'Dynein R';' A2 - MTC '};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'Dynein R - A2 - GCC';  
statevar_figure_names{index} ={'Dynein R';' A2 - GCC '};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
...
% statevar_figure_names{index} = 'RF1 - B1 - CBC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' B1 - CBC '};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
statevar_explaination{index} = 'Coat B budded total recruitment factor 1 from TNG - MTC'; 
% statevar_figure_names{index} = 'RF1 - B1 - MTC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' B1 - MTC '};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF1 - B1 - GCC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' B1 - CGC '};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
statevar_explaination{index} = 'Coat B budded total recruitment factor 1 from TNG - CBC'; 
% statevar_figure_names{index} = 'RF1 - A1 - CBC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' A1 - CBC '};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
statevar_explaination{index} = 'Coat A budded total recruitment factor 1 from TNG - MTC'; 
% statevar_figure_names{index} = 'RF1 - A1 - MTC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' A1 - MTC '};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF1 - A1 - GCC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' A1 - GCC '};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF1 - B2 - CBC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' B2 - CBC '};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
statevar_explaination{index} = 'Coat B budded total recruitment factor 1 from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'RF1 - B2 - MTC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' B2 - MTC '};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF1 - B2 - GCC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' B2 - GCC '};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF1 - A2 - CBC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' A2 - CBC '};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
statevar_explaination{index} = 'Coat A budded total recruitment factor 1 from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'RF1 - A2 - MTC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' A2 - MTC '};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF1 - A2 - GCC'; 
statevar_figure_names{index} ={'Recruitment factor 1';' A2 - GCC '};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF2 - B1 - CBC'; 
statevar_figure_names{index} ={'Recruitment factor 2';' B1 - CBC '};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
statevar_explaination{index} = 'Coat B budded total recruitment factor 2 from TNG - MTC'; 
% statevar_figure_names{index} = 'RF2 - B1 - MTC'; 
statevar_figure_names{index} ={'Recruitment factor 2';' B1 - MTC '};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF2 - B1 - GCC'; 
statevar_figure_names{index} ={'Recruitment factor 2';' B1 - GCC '};
statevar_figure_colors(index,:) = b1_color;
statevar_figure_lineStyles{index} = b1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF2 - A1 - CBC'; 
statevar_figure_names{index} ={'Recruitment factor 2';' A1 - CBC '};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
statevar_explaination{index} = 'Coat A budded total recruitment factor 2 from TNG - MTC'; 
% statevar_figure_names{index} = 'RF2 - A1 - MTC'; 
statevar_figure_names{index} ={'Recruitment factor 2';' A1 - MTC '};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF2 - A1 - GCC'; 
statevar_figure_names{index} ={'Recruitment factor 2';' A1 - GCC '};
statevar_figure_colors(index,:) = a1_color;
statevar_figure_lineStyles{index} = a1_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF2 - B2 - CBC'; 
statevar_figure_names{index} ={'Recruitment factor 2';' B2 - CBC '};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
statevar_explaination{index} = 'Coat B budded total recruitment factor 2 from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'RF2 - B2 - MTC'; 
statevar_figure_names{index} ={'Recruitment factor 2';' B2 - MTC '};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF2 - B2 - GCC'; 
statevar_figure_names{index} ={'Recruitment factor 2';' B2 - GCC '};
statevar_figure_colors(index,:) = b2_color;
statevar_figure_lineStyles{index} = b2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_figure_names{index} = 'RF2 - A2 - CBC'; 
statevar_figure_names{index} ={'Recruitment factor 2';' A2 - CBC '};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
statevar_explaination{index} = 'Coat A budded total recruitment factor 2 from plasma membrane - MTC'; 
% statevar_figure_names{index} = 'RF2 - A2 - MTC'; 
statevar_figure_names{index} ={'Recruitment factor 2';'A2 - MTC '};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
statevar_figure_names{index} ={'Recruitment factor 2';'A2 - GCC '};
statevar_figure_colors(index,:) = a2_color;
statevar_figure_lineStyles{index} = a2_lineStyle;
statevar_unit{index} = ' ';
statevar_buffer(index) = false;
...
% statevar_names{index} = 'cc2_a2_cpm';
% statevar_explaination{index} = 'Coat A budded total recruitment factor 2 from plasma membrane - GCC'; 
% statevar_figure_names{index} = 'RF2 - A2 - GCC'; 
% statevar_figure_colors(index,:) = a2_color;
% statevar_figure_lineStyles{index} = a2_lineStyle;
% statevar_unit{index} = ' ';
% statevar_buffer(index) = false;
