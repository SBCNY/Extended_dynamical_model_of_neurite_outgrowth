...
% index = index + 1;
% index_mtBlock_length = index;
% plotIndex = plotIndex + 1;
% parameters_plotIndexes(index) = plotIndex;
% parameters(index) = mtBlock_length; % = parameters(index);
% parameter_names{index} = 'mtBlock_length';
% 
% index = index + 1;
% index_mtBlock_tubulin_dimers = index;
% plotIndex = plotIndex + 1;
% parameters_plotIndexes(index) = plotIndex;
% parameters(index) = mtBlock_tubulinDimers; % = parameters(index);
% parameter_names{index} = 'mtBlock_tubulinDimers';

index = index + 1;
index_scale_initial_a  = index;
plotIndex = plotIndex + 1;
parameters_plotIndexes(index) = plotIndex;
parameters(index) = scale_initial_a; % = parameters(index);
parameter_names{index} = 'scale_initial_a';
parameter_explanation{index} = 'Scale parameter constant a';

index = index + 1;
plotIndex = plotIndex + 1;
parameters_plotIndexes(index) = plotIndex;
index_scale_exp_a = index;
parameters(index) = scale_exp_a; % = parameters(index);
parameter_names{index} = 'scale_exp_a';
parameter_explanation{index} = 'Scale parameter exponent constant a ';

index = index + 1;
index_scale_initial_b = index;
parameters(index) = scale_initial_b; % = parameters(index);
plotIndex = plotIndex + 1;
parameters_plotIndexes(index) = plotIndex;
parameter_names{index} = 'scale_initial_b';
parameter_explanation{index} = 'Scale parameter constant b';

index = index + 1;
index_exp_b = index;
parameters(index) = scale_exp_b; % = parameters(index);
plotIndex = plotIndex + 1;
parameters_plotIndexes(index) = plotIndex;
parameter_names{index} = 'scale_exp_b';
parameter_explanation{index} = 'Scale parameter exponent constant b ';

index = index + 1;
index_shape_m = index;
parameters(index) = shape_m; % = parameters(index);
plotRowIndex = plotRowIndex +1; %%%%%%%%%%%%%%%%%%%%%%%%%% new row in plot
plotIndex = plotRowIndex * plots_per_row + 1;
parameters_plotIndexes(index) = plotIndex;
parameter_names{index} = 'shape_m';
parameter_explanation{index} = 'Shape parameter constant m ';

index = index + 1;
index_shape_b = index;
parameters(index) = shape_b; % = parameters(index);
plotIndex = plotIndex + 1;
parameters_plotIndexes(index) = plotIndex;
parameter_names{index} = 'shape_b';
parameter_explanation{index} = 'Shape parameter constant b ';

index = index + 1;
index_dynMT_degradation_exp_b = index;
parameters(index) = dynMT_degradation_exp_b; % = parameters(index);
plotIndex = plotIndex + 1;
parameters_plotIndexes(index) = plotIndex;
parameter_names{index} = 'dynMT_degradation_exp_b';
parameter_explanation{index} = 'dynMT_degradation_exp_b';

index = index + 1;
index_dynMT_degradation_multiplier_a = index;
parameters(index) = dynMT_degradation_multiplier_a; % = parameters(index);
plotIndex = plotIndex + 1;
parameters_plotIndexes(index) = plotIndex;
parameter_names{index} = 'dynMT_degradation_multiplier_a';
parameter_explanation{index} = 'dynMT_degradation_multiplier_a';
