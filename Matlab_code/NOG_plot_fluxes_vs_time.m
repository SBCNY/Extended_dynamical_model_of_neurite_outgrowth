...
Output_fluxes_names =  {   {'Flux of coat A budded vesicles';' from TGN to CBC'},  {'Flux of coat A budded vesicles';' from CBC to MTC'},  {'Flux of coat A budded vesicles';' from MTC to GCC'},  {'Flux of coat A budded vesicles';' from GCC to GC'},...%4
                           {'Flux of coat B budded vesicles';' from TGN to CBC'},  {'Flux of coat B budded vesicles';' from CBC to MTC'},  {'Flux of coat B budded vesicles';' from MTC to GCC'},  {'Flux of coat B budded vesicles';' from GCC to GC'},...%8
                           {'Flux of coat A budded vesicles';' from CBC to TNG'},  {'Flux of coat A budded vesicles';' from MTC to CBC'},  {'Flux of coat A budded vesicles';' from GCC to MTC'},  {'Flux of coat A budded vesicles';' from GC to GCC'},...%12                            
                           {'Flux of coat B budded vesicles';' from CBC to TNG'},  {'Flux of coat B budded vesicles';' from MTC to CBC'},  {'Flux of coat B budded vesicles';' from GCC to MTC'},  {'Flux of coat B budded vesicles';' from GC to GCC'},...%16 
                           {'Flux of SNARE X with coat A';'from TNG to CBC'},     {'Flux of SNARE X with coat A';'from CBC to MTC'},     {'Flux of SNARE X with coat A';'from MTC to GCC'},     {'Flux of SNARE X with coat A';'from GCC to GC'},...%20
                           {'Flux of SNARE X with coat B';'from TNG to CBC'},     {'Flux of SNARE X with coat B';'from CBC to MTC'},     {'Flux of SNARE X with coat B';'from MTC to GCC'},     {'Flux of SNARE X with coat B';'from GCC to GC'},...%24
                           {'Flux of SNARE X with coat A';'from CBC to TGN'},     {'Flux of SNARE X with coat A';'from MTC to CBC'},     {'Flux of SNARE X with coat A';'from GCC to MTC'},     {'Flux of SNARE X with coat A';'from GC to GCC'},...%28   
                           {'Flux of SNARE X with coat B';'from CBC to TGN'},     {'Flux of SNARE X with coat B';'from MTC to CBC'},     {'Flux of SNARE X with coat B';'from GCC to MTC'},     {'Flux of SNARE X with coat B';'from GC to GCC'},...%32
                           {'Flux of SNARE U with coat A';'from TNG to CBC'},     {'Flux of SNARE U with coat A';'from CBC to MTC'},     {'Flux of SNARE U with coat A';'from MTC to GCC'},     {'Flux of SNARE U with coat A';'from GCC to GC'},...%36
                           {'Flux of SNARE U with coat B';'from TNG to CBC'},     {'Flux of SNARE U with coat B';'from CBC to MTC'},     {'Flux of SNARE U with coat B';'from MTC to GCC'},     {'Flux of SNARE U with coat B';'from GCC to GC'},...%40                           
                           {'Flux of SNARE U with coat A';'from CBC to TGN'},     {'Flux of SNARE U with coat A';'from MTC to CBC'},     {'Flux of SNARE U with coat A';'from GCC to MTC'},     {'Flux of SNARE U with coat A';'from GC to GCC'},...%44   
                           {'Flux of SNARE U with coat B';'from CBC to TGN'},     {'Flux of SNARE U with coat B';'from MTC to CBC'},     {'Flux of SNARE U with coat B';'from GCC to MTC'},     {'Flux of SNARE U with coat B';'from GC to GCC'},...%48                         
                           {'Flux of SNARE Y with coat A';'from TNG to CBC'},     {'Flux of SNARE Y with coat A';'from CBC to MTC'},     {'Flux of SNARE Y with coat A';'from MTC to GCC'},     {'Flux of SNARE Y with coat A';'from GCC to GC'},...%52
                           {'Flux of SNARE Y with coat B';'from TNG to CBC'},     {'Flux of SNARE Y with coat B';'from CBC to MTC'},     {'Flux of SNARE Y with coat B';'from MTC to GCC'},     {'Flux of SNARE Y with coat B';'from GCC to GC'},...%56                           
                           {'Flux of SNARE Y with coat A';'from CBC to TGN'},     {'Flux of SNARE Y with coat A';'from MTC to CBC'},     {'Flux of SNARE Y with coat A';'from GCC to MTC'},     {'Flux of SNARE Y with coat A';'from GC to GCC'},...%60   
                           {'Flux of SNARE Y with coat B';'from CBC to TGN'},     {'Flux of SNARE Y with coat B';'from MTC to CBC'},     {'Flux of SNARE Y with coat B';'from GCC to MTC'},     {'Flux of SNARE Y with coat B';'from GC to GCC'},...%64                         
                           {'Flux of SNARE V with coat A';'from TNG to CBC'},     {'Flux of SNARE V with coat A';'from CBC to MTC'},     {'Flux of SNARE V with coat A';'from MTC to GCC'},     {'Flux of SNARE V with coat A';'from GCC to GC'},...%68
                           {'Flux of SNARE V with coat B';'from TNG to CBC'},     {'Flux of SNARE V with coat B';'from CBC to MTC'},     {'Flux of SNARE V with coat B';'from MTC to GCC'},     {'Flux of SNARE V with coat B';'from GCC to GC'},...%72
                           {'Flux of SNARE V with coat A';'from CBC to TGN'},     {'Flux of SNARE V with coat A';'from MTC to CBC'},     {'Flux of SNARE V with coat A';'from GCC to MTC'},     {'Flux of SNARE V with coat A';'from GC to GCC'},...%76   
                           {'Flux of SNARE V with coat B';'from CBC to TGN'},     {'Flux of SNARE V with coat B';'from MTC to CBC'},     {'Flux of SNARE V with coat B';'from GCC to MTC'},     {'Flux of SNARE V with coat B';'from GC to GCC'},...%80
                           {'Flux of RF1  with coat A';'from TNG to CBC'},     {'Flux of RF1  with coat A';'from CBC to MTC'},    {'Flux of RF1  with coat A';'from MTC to GCC'},  {'Flux of RF1  with coat A';'from GCC to GC'},...%84
                           {'Flux of RF1  with coat B';'from TNG to CBC'},     {'Flux of RF1  with coat B';'from CBC to MTC'},    {'Flux of RF1  with coat B';'from MTC to GCC'},  {'Flux of RF1  with coat B';'from GCC to GC'},...%88
                           {'Flux of RF1 with coat A';'from CBC to TGN'},      {'Flux of RF1 with coat A';'from MTC to CBC'},     {'Flux of RF1 with coat A';'from GCC to MTC'},   {'Flux of RF1 with coat A';'from GC to GCC'},...%92   
                           {'Flux of RF1 with coat B';'from CBC to TGN'},      {'Flux of RF1 with coat B';'from MTC to CBC'},     {'Flux of RF1 with coat B';'from GCC to MTC'},   {'Flux of RF1 with coat B';'from GC to GCC'},...%96
                           {'Flux of Recruitment Factor2  with coat A';'from TNG to CBC'},     {'Flux of RF2  with coat A';'from CBC to MTC'},    {'Flux of RF2  with coat A';'from MTC to GCC'},  {'Flux of RF2  with coat A';'from GCC to GC'},...%100
                           {'Flux of RF2  with coat B';'from TNG to CBC'},     {'Flux of RF2  with coat B';'from CBC to MTC'},    {'Flux of RF2  with coat B';'from MTC to GCC'},  {'Flux of RF2  with coat B';'from GCC to GC'},...%104
                           {'Flux of RF2 with coat A';'from CBC to TGN'},      {'Flux of RF2 with coat A';'from MTC to CBC'},     {'Flux of RF2 with coat A';'from GCC to MTC'},   {'Flux of RF2 with coat A';'from GC to GCC'},...%108   
                           {'Flux of RF2 with coat B';'from CBC to TGN'},      {'Flux of RF2 with coat B';'from MTC to CBC'},     {'Flux of RF2 with coat B';'from GCC to MTC'},   {'Flux of RF2 with coat B';'from GC to GCC'},...%112
                           {'Flux of Kinesin R  with coat A';'from TNG to CBC'},               {'Flux of Kinesin R  with coat A';'from CBC to MTC'},              {'Flux of Kinesin R  with coat A';'from MTC to GCC'},            {'Flux of Kinesin R  with coat A';'from GCC to GC'},...%116
                           {'Flux of Kinesin R  with coat B';'from TNG to CBC'},               {'Flux of Kinesin R  with coat B';'from CBC to MTC'},              {'Flux of Kinesin R  with coat B';'from MTC to GCC'},            {'Flux of Kinesin R  with coat B';'from GCC to GC'},...%120                           
                           {'Flux of Kinesin R with coat A';'from CBC to TGN'},     {'Flux of Kinesin R with coat A';'from MTC to CBC'},     {'Flux of Kinesin R with coat A';'from GCC to MTC'},     {'Flux of Kinesin R with coat A';'from GC to GCC'},...%124   
                           {'Flux of Kinesin R with coat B';'from CBC to TGN'},     {'Flux of Kinesin R with coat B';'from MTC to CBC'},     {'Flux of Kinesin R with coat B';'from GCC to MTC'},     {'Flux of Kinesin R with coat B';'from GC to GCC'},...%128
                           {'Flux of Dynein R  with coat A';'from TNG to CBC'},     {'Flux of Dynein R  with coat A';'from CBC to MTC'},     {'Flux of Dynein R  with coat A';'from MTC to GCC'},     {'Flux of Dynein R  with coat A';'from GCC to GC'},...%132
                           {'Flux of Dynein R  with coat B';'from TNG to CBC'},     {'Flux of Dynein R  with coat B';'from CBC to MTC'},     {'Flux of Dynein R  with coat B';'from MTC to GCC'},     {'Flux of Dynein R  with coat B';'from GCC to GC'},...%136
                           {'Flux of Dynein R with coat A';'from CBC to TGN'},      {'Flux of Dynein R with coat A';'from MTC to CBC'},      {'Flux of Dynein R with coat A';'from GCC to MTC'},      {'Flux of Dynein R with coat A';'from GC to GCC'},...%140   
                           {'Flux of Dynein R with coat B';'from CBC to TGN'},      {'Flux of Dynein R with coat B';'from MTC to CBC'},      {'Flux of Dynein R with coat B';'from GCC to MTC'},      {'Flux of Dynein R with coat B';'from GC to GCC'}};%144
